...
public partial class BowedStringsPage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            PopulateDataListBowedStrings();

        } 
    }

    protected void PopulateDataListBowedStrings()
    {
        ProductService ps = new ProductService();
        this.DataListBowedStrings.DataSource = ps.GetProductsByCategory(2);
        this.DataListBowedStrings.DataBind();
    }
    protected void DataListBowedStrings_ItemCommand(object source, DataListCommandEventArgs e)
    {
