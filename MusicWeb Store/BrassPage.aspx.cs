...
public partial class BrassHomePage : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            PopulateDataListBrass();
        }
    }

    protected void PopulateDataListBrass()
    {
        ProductService ps = new ProductService();
        this.DataListBrass.DataSource = ps.GetProductsByCategory(3);
        this.DataListBrass.DataBind();
    }


    protected void DataListBrass_ItemCommand(object source, DataListCommandEventArgs e)
    {
